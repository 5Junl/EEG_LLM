...
def get_args():
    ...
    parser.add_argument('--output_dir', default='./checkpoints/clip/',
    ...
    parser.add_argument('--resume', default='./checkpoints/labram-base.pth', help='resume from checkpoint')
...
def main(args):
    ...
    datasets_train = [
        ["./EEG_preprocessed/train_val_test/train"], # e.g., 64 channels for dataset1 and dataset2
